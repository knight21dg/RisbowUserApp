            ...
            child: Container(
              ...
              child: SafeArea(
                ...
                child: Row(
                  ...
                  children: [
                    _buildNavItem(0, RemixIcons.home_smile_line, RemixIcons.home_smile_fill, l10n?.home ?? 'Home'),
                    _buildNavItem(1, HeroiconsOutline.squares2x2, HeroiconsSolid.squares2x2, l10n?.categories ?? 'Categories'),
                    const SizedBox(width: 60), // Space for floating button
                    _buildNavItem(3, HeroiconsOutline.buildingStorefront, HeroiconsSolid.buildingStorefront, l10n?.stores ?? 'Stores'),
                    _buildNavItem(4, HeroiconsOutline.userCircle, HeroiconsSolid.userCircle, l10n?.account ?? 'Account'),
                  ],
                ),
              ),
            ),
