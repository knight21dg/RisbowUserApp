...
class OrderRepository {
  ...
  Future<String> downloadInvoicePdf(String invoiceUrl) async {
    try {
      ...
      // 1. Fetch HTML content from invoice URL
      final dio = Dio();
      final response = await dio.get(
        invoiceUrl,
        options: Options(
          headers: AppConstant.apiBaseHelper.headers, // auth headers
          responseType: ResponseType.plain, // get HTML as string
      ...
      // 2. Convert HTML to PDF using printing package
