...
class BannersData {
  ...
  BannersData({this.top, this.carousel, this.sidebar, this.middle, this.middleTitle});
  ...
  BannersData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['middle'] != null) {
      ...
      json['middle'].forEach((v) {
        middle!.add(Top.fromJson(v));
      });
    }
    middleTitle = parseString(json['middle_title']);
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (middle != null) {
      data['middle'] = middle!.map((v) => v.toJson()).toList();
    }
    data['middle_title'] = middleTitle;
    return data;
  }
}
...
class Top {
  ...
  dynamic metadata;
  String? bannerImage;
  String? customSalePageSlug;
  int? customSalePageId;
  String? roomCode;
  ...
  Top({
    ...
    this.metadata,
    this.bannerImage,
    this.customSalePageSlug,
    this.customSalePageId,
    this.roomCode,
  });
  ...
  Top.fromJson(Map<String, dynamic> json) {
    ...
    bannerImage = parseString(json['banner_image'] ?? json['image'] ?? json['image_url'] ?? json['banner']);
    customSalePageSlug = parseString(json['custom_sale_page_slug']);
    customSalePageId = parseInt(json['custom_sale_page_id']);
    roomCode = parseString(json['room_code']);
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['custom_sale_page_slug'] = customSalePageSlug;
    data['custom_sale_page_id'] = customSalePageId;
