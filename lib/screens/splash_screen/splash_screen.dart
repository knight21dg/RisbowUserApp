...
import '../home_page/bloc/homepage_section/homepage_section_bloc.dart';
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  SplashConfig _splashConfig = const SplashConfig(type: SplashType.staticImage);
  ...
  Future<void> navigate() async {
    ...
    // Detect location in background without animation
  ...
  Widget _buildSplashContent() {
    ...
    return const SplashFallbackWidget();
  }
