          ...
          children: [
            ...
            Flexible(
              child: BlocListener<BowBloc, BowState>(
                ...
                child: Builder(
                  builder: (context) {
                    final int messageCount = state.messages.isEmpty ? 1 : state.messages.length;
                    final int totalCount = messageCount + (state.error != null ? 1 : 0);
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (index == totalCount - 1 && state.error != null) {
                          return Padding(
