...
import '../../product_detail_page/repo/recommendations_repository.dart';
import '../../product_listing_page/bloc/product_listing/product_listing_bloc.dart';
import '../../category_list_page/view/category_list_page.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  void _trackSearch(String query) {
    try {
      _recommendationsRepository.recordSearch(
        query: query,
        source: 'search_page',
      );
    } catch (e) {
  ...
  void _onSuggestionTap(String suggestion) {
    ...
    // Track the search query from suggestion
    _trackSearch(suggestion);
          ...
          Expanded(
            child: BlocBuilder<ProductListingBloc, ProductListingState>(
              builder: (context, state) {
                ...
                if (query.isEmpty) {
                  return const CategoryListPage(isEmbed: true);
                }
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (isKeyword) {
                        ...
                        return InkWell(
                          ...
                          child: Container(
                            padding: const EdgeInsets.symmetric(horizontal: 12.0, vertical: 8.0), // Adjust or remove as needed
                            child: Row(
                              children: [
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          state.error.contains('Server error') ? 'Server Error' : l10n.noProductsFound,
                          style: TextStyle(
      ...
      content: Column(
        ...
        children: [
          Icon(
            Icons.mic,
            size: 80.sp,
            color: isListening.value ? Colors.green : Colors.grey,
          ),
