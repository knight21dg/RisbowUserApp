                    ...
                    Expanded(child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 10,),
                          _buildBulletPoint(
                            AppLocalizations.of(context)!.risbowWalletBalanceValidFor1Year,
                          ),
                          SizedBox(height: 8.h),
                          _buildBulletPoint(
                            AppLocalizations.of(context)!.risbowWalletBalanceCannotBeTransferred,
                          ),
                        ],
                      ),
                    )),
                ...
                child: SizedBox(
                  ...
                  child: CustomButton(
                    onPressed: () async {
                      ...
                      if(context.mounted && selectedPaymentMethodType != null){
