...
class _RoomDetailsPageState extends State<RoomDetailsPage> {
  ...
  void _shareRoom() {
    if (_room == null) return;
    Clipboard.setData(ClipboardData(text: 'Join my room: ${_room!.code}'));
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(const SnackBar(content: Text('Room invite copied')));
  }
            ...
            Expanded(
              ...
              child: !_isMember
                  ...
                  : Container(
                      height: 50.h,
                      decoration: BoxDecoration(
                        color: room.cartItems.isEmpty || room.isClosed
                            ? Colors.grey.shade400
                            : AppColors.primary,
                        borderRadius: BorderRadius.circular(14.r),
                        boxShadow: room.cartItems.isEmpty || room.isClosed
                            ? null
                            : [
                                BoxShadow(
                                  color: AppColors.primary.withValues(alpha: 0.3),
                      ...
                      child: Material(
                        color: Colors.transparent,
                        child: InkWell(
                          onTap: room.cartItems.isEmpty || room.isClosed ? null : _checkout,
                          borderRadius: BorderRadius.circular(14.r),
                          child: Center(
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
