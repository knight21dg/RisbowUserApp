...
class PaymentSummary {
  ...
  PaymentSummary.fromJson(Map<String, dynamic> json) {
    ...
    walletAmountUsed = json['wallet_amount_used'] != null
        ...
        : null;
    // coins fields: backend may return these instead of wallet equivalents
    coinsBalance = json['coins_balance'] ?? json['wallet_balance'];
    coinsAmountUsed = json['coins_amount_used'] != null
        ? num.tryParse(json['coins_amount_used']?.toString() ?? '')
        : (json['wallet_amount_used'] != null ? num.tryParse(json['wallet_amount_used'].toString()) : null);
