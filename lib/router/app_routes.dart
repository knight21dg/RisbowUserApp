  ...
  static GoRouter router = GoRouter(
    ...
    routes: [
          ...
          StatefulShellBranch(
            routes: [
              ...
              GoRoute(
                ...
                path: AppRoutes.categoryStores,
                pageBuilder: (context, state) {
                  final extra = state.extra as Map<String, dynamic>?;
                  return platformPage(CategoryStoresPage(
                    categorySlug: extra?['categorySlug'] as String? ?? '',
                    categoryTitle: extra?['categoryTitle'] as String?,
                    selectedSubcategorySlug: extra?['selectedSubcategorySlug'] as String?,
                  ));
                },
              ),
              GoRoute(
                ...
                pageBuilder: (context, state) {
                  ...
                  return platformPage(CategoryStoreProductsPage(
                    ...
                    categorySlug: extra['categorySlug'] as String? ?? '',
                    parentCategorySlug: extra['parentCategorySlug'] as String?,
                  ));
                },
              ),
            ],
      ...
      GoRoute(
        name: 'bow-chat',
        path: AppRoutes.chat,
        pageBuilder: (context, state) => platformPage(const ChatPage()),
      ),
