...
class AppColors {
  ...
  static const Color headingColor = AppTheme.headingColor;
  static const Color subtitleColor = AppTheme.subtitleColor;
}

class AppTheme {
  /// App main color - Modern Blue
  static const Color primaryColor = Color(0xFF1565C0);
  static Color primaryVariant = primaryColor.withValues(alpha: 0.8);

  /// Brand Colors - Cream, Blue, Orange
  static const Color creamColor = Color(0xFFFAF8F5);
