...
class FeatureSettingsService {
  ...
  static FeatureSettingsService get instance =>
      _instance ??= FeatureSettingsService._();
  ...
  bool get nearbyStoresEnabled =>
      _cachedFeatures['nearbyStoresEnabled'] ?? true;
  ...
  Future<void> fetchFeatureSettings() async {
    try {
      final response = await _api.getAPICall(ApiRoutes.featureSettingsApi, {});
