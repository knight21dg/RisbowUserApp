        ...
        child: safeImagePath.isEmpty
            ...
            : (_isNetworkImage(safeImagePath) && !_isRecentlyFailed(safeImagePath))
                ? CachedNetworkImage(
                    ...
                    height: widget.height,
                    fit: widget.fit,
                    memCacheWidth: widget.width != null && widget.width != double.infinity ? (widget.width! * 3).toInt() : null,
                    memCacheHeight: widget.height != null && widget.height != double.infinity ? (widget.height! * 3).toInt() : null,
