...
class _CustomScaffoldState extends State<CustomScaffold> with TickerProviderStateMixin {
  ...
  Widget _buildCartButton(BuildContext context, CartState cartBlocState) {
    return AnimatedButton(
      ...
      child: Container(
        width: _widthAnimation.value + 30.w, // Increased width for larger pill
        height: isTablet(context) ? 48.h : 42.h, // Increased height - user requested bigger
        ...
        child: Stack(
          children: [
            ...
            if (_getCartItems(cartBlocState).isNotEmpty)
              Positioned(
                left: _widthAnimation.value < 40.0.w ? 6.w : 20.w,
                top: 4.h,
                bottom: 4.h,
                child: Center(
                  child: Transform.translate(
                    offset: _widthAnimation.value < 48.0.w
                        ? Offset.zero
                        : _imageSlideAnimation.value * 22.w,
                    child: _widthAnimation.value < 48.0.w
                        ? SingleProductImage(
                      imageUrl: _getCartItems(cartBlocState).isNotEmpty 
                          ? _getCartItems(cartBlocState).first 
                          : '',
                    )
                        : AnimatedFacePile(
            ...
            if (_widthAnimation.value > 40.0.w)
              Center(
                child: Opacity(
                  ...
                  child: Row(
                    ...
                    children: [
                      SizedBox(width: 58.w), // Increased spacing for avatars
                      Expanded(
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
