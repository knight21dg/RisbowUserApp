...
@override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: onTap ?? () {
        final storeParam = storeSlug.isNotEmpty ? '&store=$storeSlug' : '';
        context.push('/product-detail?slug=$productSlug$storeParam');
      },
      child: Opacity(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      productImageWidget(
                          ...
                          discountPercentage: PriceUtils.calculateDiscountPercentage(double.tryParse(productPrice) ?? 0.0, double.tryParse(specialPrice) ?? 0.0).toString(),
                        context: context
                      ),
