...
class ApiRoutes {
  ...
  static String cartItemApi = '${AppConstant.baseUrl}user/cart/item/';
  ...
  static String roomCheckoutInitiateApi(String code) => '${AppConstant.baseUrl}rooms/$code/checkout/initiate';
  static String roomCheckoutPaymentStatusApi(String code) => '${AppConstant.baseUrl}rooms/$code/checkout/payment-status';
  static String roomCheckoutPayApi(String code) => '${AppConstant.baseUrl}rooms/$code/checkout/pay';
...
// AI Chat (Bow) API
  ...
  // SDUI Schema (published)
  static String sduiSchemaApi = '${AppConstant.baseUrl}sdui/schema';
  static String sduiExperimentApi = '${AppConstant.baseUrl}sdui/experiment';
}
