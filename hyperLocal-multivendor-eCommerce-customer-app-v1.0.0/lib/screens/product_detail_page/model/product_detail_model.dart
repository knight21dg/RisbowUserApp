...
class ProductData {
  ...
  // Store API fields
  late double price;
  late double? priceExcludeTax;
  late double specialPrice;
  late double? specialPriceExcludeTax;
  late double mrp;
  ...
  ProductData.fromJson(Map<String, dynamic> json) {
    try {
      ...
      priceExcludeTax = json['price_exclude_tax']?.toDouble();
      specialPrice = (json['specialPrice'] ?? json['special_price'] ?? json['price'] ?? 0).toDouble();
      specialPriceExcludeTax = json['special_price_exclude_tax']?.toDouble();
...
class ProductVariants {
  ...
  ProductVariants({
    ...
    this.specialPriceExcludeTax = specialPriceExcludeTax;
    this.mrp = mrp ?? 0;
    ...
    this.stock = stock ?? 0;
    this.sku = sku ?? '';
    this.isGroupBuyEnabled = isGroupBuyEnabled ?? false;
    this.groupBuyPrice = groupBuyPrice ?? 0;
    this.attributes = attributes ?? {};
  }
  ...
  ProductVariants.fromJson(Map<String, dynamic> json) {
    ...
    breadth = _parseInt(json['breadth']);
    length = _parseInt(json['length']);
    availability = json['availability'] ?? false;
    barcode = json['barcode']?.toString() ?? '';
    isDefault = json['is_default'] ?? false;
    price = _parseInt(json['price']);
    specialPrice = _parseInt(json['special_price']);
    priceExcludeTax = json['price_exclude_tax']?.toDouble();
    specialPriceExcludeTax = json['special_price_exclude_tax']?.toDouble();
    mrp = _parseDouble(json['mrp'] ?? json['price']);
    discountAmount = _parseDouble(json['discount_amount']);
    finalAmount = _parseDouble(json['final_amount'] ?? json['special_price'] ?? json['price']);
    ...
    groupBuyPrice = _parseInt(json['group_buy_price']);
  ...
  /// Safely parse any value (int, double, String) to int
  ...
  /// Safely parse any value (int, double, String) to double
