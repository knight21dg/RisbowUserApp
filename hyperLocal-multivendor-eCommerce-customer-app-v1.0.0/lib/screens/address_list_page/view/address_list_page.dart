...
class _AddressListPageState extends State<AddressListPage> {
  ...
  Widget _buildAddressCard(AddressListData address) {
    final bool isSelected = selectedAddressId != null && address.id == selectedAddressId;
  ...
  void _navigateToEditAddress(AddressListData address) async {
    await GoRouter.of(context).push(
      ...
      extra: {
        'isFromAddressPage': true,
        'lat': double.tryParse(address.latitude ?? '0.0') ?? 0.0,
        'lng': double.tryParse(address.longitude ?? '0.0') ?? 0.0,
                    ...
                    return TextButton(
                      onPressed: isRemoving
                          ...
                          if (address.id != null) {
                            ...
                            ToastManager.show(context: context, message: 'Invalid address ID');
                          }
                      },
                      child: isRemoving
                          ? SizedBox(
