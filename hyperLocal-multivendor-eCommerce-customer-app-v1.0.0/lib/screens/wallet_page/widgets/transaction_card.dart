...
class TransactionCard extends StatelessWidget {
          ...
          Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  _formatStatus(removeUnderscores(transaction.status ?? 'pending')),
                  style: TextStyle(
  ...
  String _formatAmount(num? amount, String? currencyCode) {
    if (amount == null) return '0';

    final double amountValue = amount?.toDouble() ?? 0;
