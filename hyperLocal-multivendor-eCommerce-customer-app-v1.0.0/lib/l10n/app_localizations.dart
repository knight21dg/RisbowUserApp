...
abstract class AppLocalizations {
  ...
  /// No description provided for @risbowWalletBalanceValidFor1Year.
  ///
  /// In en, this message translates to:
  /// **'Risbow Wallet balance is valid for 1 year from the date of money added'**
  String get risbowWalletBalanceValidFor1Year;

  /// No description provided for @risbowWalletBalanceCannotBeTransferred.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @freeGift.
  ///
  /// In en, this message translates to:
  /// **'Free Gift'**
  String get freeGift;

  /// No description provided for @bowAssistant.
  ///
  /// In en, this message translates to:
  /// **'BOW Assistant'**
  String get bowAssistant;
  ...
  /// No description provided for @bowSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Your AI shopping assistant'**
  String get bowSubtitle;

  /// No description provided for @askBow.
  ///
  /// In en, this message translates to:
  /// **'Ask BOW anything...'**
  String get askBow;
  ...
  ///
  /// In en, this message translates to:
  /// **'Store is currently not available.'**
