...
class SystemSettings {
  ...
  final bool? enableProofOfQualityVideo;
  final String? platformChargePercent;
  final String? cgstPercent;
  final String? sgstPercent;
  final bool? enableHandlingCharges;
  final bool? enablePerStoreDropOffFee;
  ...
  SystemSettings({
    ...
    this.enableProofOfQualityVideo,
    this.platformChargePercent,
    this.cgstPercent,
    this.sgstPercent,
    this.enableHandlingCharges,
    this.enablePerStoreDropOffFee,
  });
  ...
  factory SystemSettings.fromJson(Map<String, dynamic> json) {
    return SystemSettings(
      ...
      enableProofOfQualityVideo: json['enableProofOfQualityVideo'] as bool?,
      platformChargePercent: json['platformChargePercent']?.toString(),
      cgstPercent: json['cgstPercent']?.toString(),
      sgstPercent: json['sgstPercent']?.toString(),
      enableHandlingCharges: json['enableHandlingCharges'] as bool?,
      enablePerStoreDropOffFee: json['enablePerStoreDropOffFee'] as bool?,
    );
  }
}
...
class WebSettings {
  ...
  final String statusBarLightColor;
  final String statusBarDarkColor;
...
required this.privacyPolicy,
      ...
      required this.statusBarLightColor,
      required this.statusBarDarkColor,
  });
  ...
  factory WebSettings.fromJson(Map<String, dynamic> json) {
    return WebSettings(
      ...
      statusBarLightColor: json['statusBarLightColor'] as String? ?? '#f8f9fa',
      statusBarDarkColor: json['statusBarDarkColor'] as String? ?? '#000000',
    );
  }
}
...
class AppSettings {
  ...
  factory AppSettings.fromJson(Map<String, dynamic> json) {
    return AppSettings(
      ...
      splashScreen: json['splashScreen'] as String?,
      appIcon: json['appIcon'] as String?,
      splashBackgroundColor: json['splashBackgroundColor'] as String? ?? '#FFFFFF',
      splashDuration: json['splashDuration'] as int? ?? 3000,
    );
  }
}

/// Specific model for 'mobile_app' settings.
